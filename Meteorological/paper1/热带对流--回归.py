...
try:
    # 读取相关系数
    reg_lbm_t2m_z200 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_z200.nc')
    reg_lbm_t2m_u200 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_u200.nc')
    reg_lbm_t2m_v200 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_v200.nc')
    reg_lbm_t2m_z500 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_z500.nc')
    reg_lbm_t2m_u500 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_u500.nc')
    reg_lbm_t2m_v500 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_v500.nc')
    reg_lbm_t2m_z850 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_z850.nc')
    reg_lbm_t2m_u850 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_u850.nc')
    reg_lbm_t2m_v850 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_v850.nc')
    reg_lbm_t2m_pre = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_pre.nc')
except:
    # 将数据回归到PC上
    ...
    xr.DataArray(reg_z200, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_z200.nc')
    ...
    xr.DataArray(reg_u200, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_u200.nc')
    ...
    xr.DataArray(reg_v200, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_v200.nc')
    ...
    xr.DataArray(reg_z500, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_z500.nc')
    ...
    xr.DataArray(reg_u500, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_u500.nc')
    ...
    xr.DataArray(reg_v500, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_v500.nc')
    ...
    xr.DataArray(reg_z850, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_z850.nc')
    ...
    xr.DataArray(reg_u850, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_u850.nc')
    ...
    xr.DataArray(reg_v850, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_v850.nc')
    ...
    xr.DataArray(reg_pre, coords=[lat_pre, lon_pre], dims=['lat', 'lon']).to_netcdf(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_pre.nc')
    ###数据再读取
    reg_lbm_t2m_z200 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_z200.nc')
    reg_lbm_t2m_u200 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_u200.nc')
    reg_lbm_t2m_v200 = xr.open_dataset(r'D:\PyFile\paper1\cache\reg_lbm\reg_lbm_sst_v200.nc')
...
plt.savefig(r'D:\PyFile\pic\热带对流回归.png', dpi=600, bbox_inches='tight')
plt.show()
