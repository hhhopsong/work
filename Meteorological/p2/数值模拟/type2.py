...
def draw_frc():
    ...
    ax1_.set_title('a) Exp NT 200hPa UV&FRC', fontsize=10, loc='left')
    ...
    ax2_.set_title('b) Exp NT 500hPa UV&FRC', fontsize=10, loc='left')
    ...
    ax4_.set_title('c) Exp NT 850hPa UV&FRC', fontsize=10, loc='left')
