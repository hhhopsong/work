...
def draw_frc():
    ...
    plot_text(axd, 130, 15, 'C', 12, 'red')
    plot_text(axd, 140, 45, 'A', 12, 'blue')

    plot_text(axe, 145, 15, 'C', 12, 'red')
    plot_text(axe, 148, 37, 'A', 12, 'blue')

    plot_text(axf, 155, 10, 'A', 12, 'blue')
    ########################
    plot_text(axa, -70, 42, 'A', 12, 'blue')
