...
def draw_frc():
    ...
    ax1_.set_title('a) Exp NAS 200hPa UV&FRC', fontsize=10, loc='left')
    ...
    wind200 = Curlyquiver(ax1_, lon_UV, lat, U, V, arrowsize=.5, scale=scale, regrid=13, linewidth=.25, nanmax=10,
                        color="k", center_lon=c_lon_1, thinning=[.3, 'min'], MinDistance=[0.2, 0.1])
    ...
    ax2_.set_title('b) Exp NAS 500hPa UV&FRC', fontsize=10, loc='left')
    ...
    var_contr = ax2_.contourf(lon_fill_white, frc_nc_p[var]['lat'], np.where((frc_fill_white >= zero_mask) | (frc_fill_white <= -zero_mask), frc_fill_white, np.nan),
                        levels=lev_range, cmap=plt.cm.PuOr_r, transform=ccrs.PlateCarree(central_longitude=0), extend='both')
    wind500 = Curlyquiver(ax2_, lon_UV, lat, U, V, arrowsize=.5, scale=scale, regrid=13, linewidth=.25, nanmax=wind200.nanmax,
                           color="k", center_lon=c_lon_1, thinning=[.15, 'min'], MinDistance=[0.2, 0.1])
    ...
    ax4_.set_title('c) Exp NAS 850hPa UV&FRC', fontsize=10, loc='left')
    ...
    wind850 = Curlyquiver(ax4_, lon_UV, lat, U, V, arrowsize=.5, scale=scale/2, regrid=13, linewidth=.25, nanmax=wind200.nanmax,
                           color="k", center_lon=c_lon_1, thinning=[.15, 'min'], MinDistance=[0.2, 0.1])
    ...
    ax1.set_title('d) Exp TPS 200hPa UV&FRC', fontsize=10, loc='left')
    ax1.set_aspect('auto')
    ...
    ax2.set_title('e) Exp TPS 500hPa UV&FRC', fontsize=10, loc='left')
    ax2.set_aspect('auto')
    ...
    var_contr = ax2.contourf(lon_fill_white, frc_nc_p[var]['lat'], np.where((frc_fill_white >= zero_mask) | (frc_fill_white <= -zero_mask), frc_fill_white, np.nan),
                        levels=lev_range, cmap=cmaps.MPL_RdYlGn[22+0:56] + cmaps.CBR_wet[0] + cmaps.MPL_RdYlGn[72:106-0], transform=ccrs.PlateCarree(central_longitude=0), extend='both')
    wind500 = Curlyquiver(ax2, lon_UV, lat, U, V, arrowsize=.5, scale=scale, regrid=13, linewidth=.25, nanmax=wind200.nanmax,
                           color="k", center_lon=c_lon_1, thinning=[.15, 'min'], MinDistance=[0.2, 0.1])
    wind500.key(fig, U=1.5, label='1.5 m/s', ud=7.8, edgecolor='none', arrowsize=.5, linewidth=.5, fontproperties={'size': 8})
    ...
    ax4.set_title('f) Exp TPS 850hPa UV&FRC', fontsize=10, loc='left')
    ax4.set_aspect('auto')
    ...
    var_contr = ax4.contourf(lon_fill_white, frc_nc_p[var]['lat'], np.where((frc_fill_white >= zero_mask) | (frc_fill_white <= -zero_mask), frc_fill_white, np.nan),
                        levels=lev_range, cmap=cmaps.MPL_RdYlGn[22+0:56] + cmaps.CBR_wet[0] + cmaps.MPL_RdYlGn[72:106-0], transform=ccrs.PlateCarree(central_longitude=0), extend='both')
    #z850 = ax4.contour(lon_Z, lat, Z, levels=4, colors='black', transform=ccrs.PlateCarree(central_longitude=0), linewidths=0.4)
    wind850 = Curlyquiver(ax4, lon_UV, lat, U, V, arrowsize=.5, scale=scale/2, regrid=13, linewidth=.25, nanmax=wind200.nanmax,
                           color="k", center_lon=c_lon_1, thinning=[.15, 'min'], MinDistance=[0.2, 0.1])
    ...
    var_contr = ax2.contourf(lon_fill_white2, frc_nc_p[var2]['lat'],
                             ...
                             cmap=plt.cm.PuOr_r,
                             transform=ccrs.PlateCarree(central_longitude=0), extend='both')
    wind500 = Curlyquiver(ax2, lon_UV, lat, U, V, arrowsize=.5, scale=scale, regrid=13, linewidth=.25,
                          nanmax=wind200.nanmax, color="k", center_lon=c_lon_1, thinning=[.15, 'min'], MinDistance=[0.2, 0.1])
    wind500.key(fig, U=1.5, label='1.5 m/s', ud=7.8, edgecolor='none', arrowsize=.5, linewidth=.5, fontproperties={'size': 8})
    ...
    var_contr = ax4.contourf(lon_fill_white2, frc_nc_p[var2]['lat'],
                             ...
                             transform=ccrs.PlateCarree(central_longitude=0), extend='both')
    # z850 = ax4.contour(lon_Z, lat, Z, levels=4, colors='black', transform=ccrs.PlateCarree(central_longitude=0), linewidths=0.4)
    wind850 = Curlyquiver(ax4, lon_UV, lat, U, V, arrowsize=.5, scale=scale/2, regrid=13, linewidth=.25,
    ...
    plt.savefig(r'D:\PyFile\p2\pic\Output_对流实验_type2_single.png', dpi=600, bbox_inches='tight')
    plt.show()
