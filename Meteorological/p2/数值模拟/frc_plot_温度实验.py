...
def draw_frc():
    ...
    wind200.key(fig, U=0.02, label='0.02 m/s', ud=7.7, edgecolor='none', arrowsize=.5, color='k')
    # 图2
    lev = 500
    lev_Z = np.array([-10, -5, 5, 10]) * 2
    extent1 = extent1
    ...
    wind500 = Curlyquiver(ax2, lon_UV, lat, U, V, arrowsize=.2, scale=20, regrid=20, linewidth=0.25,
                        color='black', center_lon=180-70)
    wind500.key(fig, U=0.02, label='0.02 m/s', ud=7.7, edgecolor='none', arrowsize=.5, color='k')
    ...
    wind850 = Curlyquiver(ax3, lon_UV, lat, U, V, arrowsize=.2, scale=20, regrid=20, linewidth=0.25,
                        color='black', center_lon=180-70)
    wind850.key(fig, U=0.02, label='0.02 m/s', ud=7.7, edgecolor='none', arrowsize=.5, color='k')
