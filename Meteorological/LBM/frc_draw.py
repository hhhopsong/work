...
lbm = xr.open_dataset(r'\\wsl.localhost\Ubuntu-20.04\home\hopsong\lbm\data\out\Output_frc.t42l20.Tingyang.Heating_CP62N49W.nc')
u = lbm['u'][19:30].mean('time')
v = lbm['v'][19:30].mean('time')
t = lbm['t'][19:30].mean('time')
z = lbm['z'][19:30].mean('time')
lon = lbm['lon']
lat = lbm['lat']
# 绘图
# 图1
...
wind200 = ax1.streamplot(lon_T[::n], lat[::n], U[::n, ::n], V[::n, ::n], density=2, linewidth=0.3, arrowsize=0.5, transform=ccrs.PlateCarree())
...
wind500 = ax2.streamplot(lon_T[::n], lat[::n], U[::n, ::n], V[::n, ::n], density=2, linewidth=0.3, arrowsize=0.5, transform=ccrs.PlateCarree())
