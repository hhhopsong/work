...
PR_time = [2005, 2022]
TYPE = 3
timeSerie = typesTimeSer.sel(type=TYPE)['I']
...
# 保存信息表
meta_df.to_csv(
    fr"{PYFILE}/p3/data/type{TYPE}_auto_predictor_catalog.csv",
    index=False,
    encoding='utf-8-sig'
)
...
plt.savefig(fr'{PYFILE}/p3/pic/type{TYPE}_auto.pdf', bbox_inches='tight')
plt.savefig(fr'{PYFILE}/p3/pic/type{TYPE}_auto.png', dpi=600, bbox_inches='tight')
