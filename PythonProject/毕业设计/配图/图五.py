...
try:
    # 读取相关系数
    reg_waf_x = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_waf_x_2.nc')
    reg_waf_y = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_waf_y_2.nc')
    reg_z200 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_z200_2.nc')
    reg_z500 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_z500_2.nc')
    reg_z850 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_z850_2.nc')
    reg_u200 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_u200_2.nc')
    reg_u500 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_u500_2.nc')
    reg_u850 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_u850_2.nc')
    reg_v200 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_v200_2.nc')
    reg_v500 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_v500_2.nc')
    reg_v850 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_v850_2.nc')
    reg_sst = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_sst_2.nc')
    reg_pre = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_pre_2.nc')
except:
    ...
    xr.DataArray(reg_waf_x, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_waf_x_2.nc')
    xr.DataArray(reg_waf_y, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_waf_y_2.nc')
    xr.DataArray(reg_z200, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_z200_2.nc')
    xr.DataArray(reg_u200, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_u200_2.nc')
    xr.DataArray(reg_v200, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_v200_2.nc')
    ###
    ...
    xr.DataArray(reg_z500, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_z500_2.nc')
    xr.DataArray(reg_u500, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_u500_2.nc')
    xr.DataArray(reg_v500, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_v500_2.nc')
    xr.DataArray(reg_sst, coords=[lat_sst, lon_sst], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_sst_2.nc')
    ###
    ...
    xr.DataArray(reg_z850, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_z850_2.nc')
    xr.DataArray(reg_u850, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_u850_2.nc')
    xr.DataArray(reg_v850, coords=[lat_uvz, lon_uvz], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_v850_2.nc')
    xr.DataArray(reg_pre, coords=[lat_pre, lon_pre], dims=['lat', 'lon']).to_netcdf(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_pre_2.nc')
    ###数据再读取
    reg_waf_x = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_waf_x_2.nc')
    reg_waf_y = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_waf_y_2.nc')
    reg_z200 = xr.open_dataset(r'D:\CODES\Python\PythonProject\cache\Graduation Thesis\reg_z200_2.nc')
...
a1_waf = ax1.quiver(a1_waf_lon[::n], lat_uvz[:360:n], reg_waf_x[:360:n, ::n], reg_waf_y[:360:n, ::n],
                    scale=18, color='black', headlength=2, headaxislength=2, transform = ccrs.PlateCarree(central_longitude=0))
...
plt.savefig(r'C:\Users\10574\OneDrive\File\Graduation Thesis\论文配图\图5改.png', dpi=1000, bbox_inches='tight')
plt.show()
