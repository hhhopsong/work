...
!====================================================================   
    module pra_data_mod
      ...
      real,parameter :: LearningRate  = 0.05                       ! LearningRate should be turned based on performance. Suggest 0.01~0.1
      integer,parameter ::  SeedNNstate=79                          ! used for the NNstate_init
