...
# 调出2020年7月18日8:00数据(时次:796   [层次:5(500hPa) 10(200hPa)]  范围:lat12-32;lon28-56   格点:25 * 41)
lon = q['lon'][24:65]
lat = q['lat'][8:33]
Q = q['rhum'][796][:10, 8:33, 24:65]
T = t['air'][796][:10, 8:33, 24:65]
...
ax1.set_title(f'2020-07-18 8:00 大气可降水量分布图(×10$^-$$^2$mm)', color='black', fontsize=15)
ax1.set_extent([60, 160, 10, 70], crs=ccrs.PlateCarree())
a1 = ax1.contourf(lon, lat, PW, cmap='Spectral_r', levels=level1, extend='both', transform=ccrs.PlateCarree())
ax1.coastlines()
...
plt.savefig('D:/tz_shixi/实习6/实习6_1.png', dpi=1500, bbox_inches='tight')
plt.show()
